...
public final class ImageData {
	...
	private static ImageIcon settingIcon = new ImageIcon("./img/settingimg.png");
	private static Image settingImage = settingIcon.getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH);
//	private static ImageIcon
	...
	public static void setSettingIcon(ImageIcon settingIcon) {
		ImageData.settingIcon = settingIcon;
	}
	
	public static Image getSettingIamge() {
		return settingImage;
	}
	public static void setSettingImage(Image settingImage) {
		ImageData.settingImage = settingImage;
	}
